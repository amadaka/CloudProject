...
<body>
  ...
  <a class="active2" href="courseController?action=studentpastlist">Your Past Courses</a>
  ...
  <a href="courseController?action=studentallupcominglist">Upcoming Courses</a>
    ...
    <div class="mission60004">
      <h2>List of Courses you took in past</h2>
     <table class="center">
       <tr>
         <th>Class Number</th>
         <th>Class Name</th>
         ...
         <th>Action</th>
              ...
              <c:forEach items="${paststuCourse}" var="item" varStatus="status">
       <tr>
           <td>${item.id_class}</td>
