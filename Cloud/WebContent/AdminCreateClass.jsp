...
<div class="body">
  ...
  <a class="active2" href="courseController?action=redirectCreatePage">Create Courses</a>
  ...
  <a href="courseController?action=adminupcominglist">Upcoming Courses</a>
    ...
    <div class="mission601">
      <h1>Class <span><i>Details</i></span></h1>
      	<form name="newevent" class="mission88888" action="/Cloud/courseController?createClass" method="post">
      		<table class="center">
      			<tr>
      				<td><h3>Class <span>Name:</span></h3></td>
      				<td>
      					<select class="lecting" name="course">
      					<c:forEach items="${courseList}" var="item" varStatus="status">
      					<option value="${item.id_class}">${item.classname}</option>
      					</c:forEach>
      					</select>
      				</td>
      			</tr>
      			...
      			<tr>
      				...
      				<td>
      					<select class="lecting" name="teach">
      		...
      		<input name="action" value="createClass" type="hidden">
           <input type="submit" value="createClass" name="eventnew">
      	</form>
      </div>
  </div>
 <br>
