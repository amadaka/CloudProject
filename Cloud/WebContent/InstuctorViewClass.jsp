...
<body>
  ...
  <h2>Lecture</h2>
     <table class="center">
      ...
      <h1>Class <span><i>Details</i></span></h1>
      	<form name="newevent" class="mission88888" action="/Cloud/lectureController?createlecture&id=${courT.idcreate}" method="post">
      		<table class="center">
      		
      		<tr>
      				<td><h3>Lecture <span>Name:</span></h3></td>
      				<td>
      					<input type="text" name="llname" required>
      				</td>
      			</tr>
      			<tr>
      				<td><h3>Lecture <span>Link:</span></h3></td>
      				<td>
      					<input type="text" name="llline" required>
      				</td>
      			</tr>
      			</table>
      		 <br>
    
      		<input name="action" value="createlecture" type="hidden">
           <input type="submit" value="createlecture" name="eventnew">
      	</form>
      </div>
