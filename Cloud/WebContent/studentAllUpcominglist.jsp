...
<body>
  ...
  <a class="active2" href="courseController?action=studentallupcominglist">Upcoming Courses</a>
</div>
    <div class="mission60004">
      <h2>List of Upcoming Courses</h2>
     <table class="center">
       <tr>
         <th>Class Number</th>
         <th>Class Name</th>
       ...
       <c:forEach items="${upallstuCourse}" var="item" varStatus="status">
       <tr>
           <td>${item.id_class}</td>
           ...
           <td><a onclick="return confirm(\'Are you sure?\')" href="reserveController?action=reserveclass&id=${item.idcreate}">Reserve</a></td>
           </tr>
           </c:forEach>
     </table>
   </div>
