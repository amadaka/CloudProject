...
<body>
  ...
  <a class="active2" href="courseController?action=adminpastlist">Past Courses</a>
  <a href="courseController?action=adminupcominglist">Upcoming Courses</a>
</div>
    <div class="mission60004">
      <h2>List of Past Classes</h2>
     <table class="center">
       <tr>
         <th>Class Number</th>
         <th>Event Name</th>
       ...
       <c:forEach items="${pastCourse}" var="item" varStatus="status">
       <tr>
           <td>${item.id_class}</td>
